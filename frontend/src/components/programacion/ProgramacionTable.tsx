...
import { generarDiasMes, agruparEmpleadosPorArea, obtenerTurnoAsignado, type DiaMes } from '@/lib/programacion.utils';
              ...
              <TableRow className="bg-muted">
                ...
                {diasMes.map((dia) => {
                  ...
                  return (
                    <TableHead
                      key={dia.fecha}
                      className={`text-center min-w-[70px] max-w-[70px] border-r p-1 ${
                        esDiaEspecial ? 'bg-red-100 dark:bg-red-900/30' : 'bg-muted/50'
                      }`}
                    >
