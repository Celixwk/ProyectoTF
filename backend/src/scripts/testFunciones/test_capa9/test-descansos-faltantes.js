...
async function testCertificacionDescansos() {
    ...
    const emps = [{ id_empleado: idEmp, nombre_completo: "Test User" }];
    ...
    const res1 = (0, capa9_deteccionProblemas_1.capa9_detectarProblemas)(prog27, empMock, [], new Map(), fecha30, {
    ...
    const res2 = (0, capa9_deteccionProblemas_1.capa9_detectarProblemas)(prog27, empMock, [], new Map(), fecha30, {
    ...
    const res3 = (0, capa9_deteccionProblemas_1.capa9_detectarProblemas)(prog16, empMock, [], new Map(), fecha30, {
    ...
    const res4 = (0, capa9_deteccionProblemas_1.capa9_detectarProblemas)(progDoble, empMock, [], new Map(), fecha30, {
    ...
    const res5 = (0, capa9_deteccionProblemas_1.capa9_detectarProblemas)(progFeb, empMock, [], new Map(), fechaFeb, {
        descansosRequeridos: new Map([[idEmp, 4]]), empleados: emps
    });
