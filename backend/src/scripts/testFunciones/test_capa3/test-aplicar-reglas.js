...
async function main() {
    ...
    for (const area of areasPrueba) {
        ...
        const elegibles = (0, capa3_reglasArea_1.capa3_aplicarReglasArea)(area, empleadosMock, new Map());
    ...
    const tests = [
        {
            ...
            test: () => {
                const elegibles = (0, capa3_reglasArea_1.capa3_aplicarReglasArea)({ id_area: 2, nombre_area: "Puertas y Sala" }, empleadosMock, new Map());
        ...
        },
        {
            ...
            test: () => {
                const elegibles = (0, capa3_reglasArea_1.capa3_aplicarReglasArea)({ id_area: 9, nombre_area: "Parqueadero 1" }, empleadosMock, new Map());
                const ids = elegibles.map(e => e.id_empleado).sort();
        ...
        },
        {
            ...
            test: () => {
                const elegibles = (0, capa3_reglasArea_1.capa3_aplicarReglasArea)({ id_area: 13, nombre_area: "Refuerzos" }, empleadosMock, new Map());
                const ids = elegibles.map(e => e.id_empleado).sort();
        ...
        },
        {
            ...
            test: () => {
                const elegibles = (0, capa3_reglasArea_1.capa3_aplicarReglasArea)({ id_area: 1, nombre_area: "Sala Principal" }, empleadosMock, new Map());
